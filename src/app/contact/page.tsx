            ...
            <section className="relative min-h-[80vh] grid lg:grid-cols-2">
                ...
                <div className="flex items-center bg-[#f7f7f7] dark:from-slate-900 dark:via-slate-900 dark:to-blue-950 px-6 py-24">
                    <div className="max-w-xl mx-auto">
                        <h1 className="text-3xl sm:text-5xl md:text-7xl font-thin-100 text-slate-900 dark:text-white mb-6">
                            Contact Us
                        </h1>
                ...
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-10">
                            <div>
                                <h2 className="text-3xl sm:text-5xl md:text-7xl font-thin-100 text-slate-900 dark:text-white mb-6">
                                    Get in touch
                                </h2>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="group flex items-start space-x-4 p-4 ">
                                    <div className="w-12 h-12 dark:bg-blue-950 rounded-xl flex items-center justify-center text-blue-600 ">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-1">
                                            <a href="mailto:info@tecverse.io" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors block">
                                                info@tecverse.io
                                            </a>
                                            <a href="mailto:sales@tecverse.ai" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors block">
                                                sales@tecverse.ai
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className="group flex items-start space-x-4 p-4 ">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-1">
                                            <a href="tel:+15551234567" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors block">
                                                +1 (555) 123-4567
                                            </a>
                                            <a href="tel:+15559876543" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors block">
                                                +1 (555) 987-6543
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="group flex items-start space-x-4 p-6 rounded-2xl bg-white dark:bg-slate-900 shadow-sm hover:shadow-md transition-all duration-300">
                                        ...
                                        <div className="w-12 h-12 bg-blue-50 dark:bg-blue-950 rounded-xl flex items-center justify-center text-blue-600 dark:text-blue-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            ...
                            {/* <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
                                ...
                                <div className="flex space-x-4">
                                    <a href="#" className="w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300">
                                    ...
                                    <a href="https://www.linkedin.com/company/tecverseio/?originalSubdomain=au" className="w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
