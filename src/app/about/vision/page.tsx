            ...
            <section className="py-24 bg-white dark:bg-slate-950">
                <Container>
                    <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
                        <p className="text-2xl text-slate-600 dark:text-slate-300 font-light leading-relaxed text-center">
                        ...
                        <div className="mt-16 grid gap-12 md:grid-cols-2">
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Innovation for Good</h3>
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Global Connectivity</h3>
                                <p className="text-gray-600 dark:text-gray-400">
