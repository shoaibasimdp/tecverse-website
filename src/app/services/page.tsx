            ...
            <section className="relative min-h-[70vh] flex items-center">
                ...
                <Container className="relative z-10">
                    <div className="max-w-5xl">
                        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6">
                            Our Services
                        </h1>
