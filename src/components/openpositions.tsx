        ...
        >
            <Container>
                ...
                <div className="text-center mb-16 max-w-5xl mx-auto">
                    <h2 className="text-4xl md:text-7xl font-Inter tracking-tight text-[#014f86] dark:text-white mb-6">
                        Join Our Team
                    </h2>
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-12 p-2 bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="flex-1 relative group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <Search className="h-5 w-5 text-slate-400 group-focus-within:text-[#014f86] transition-colors" />
                        </div>
                        <input
                            type="text"
                            ...
                            className="w-full pl-11 pr-4 py-4 bg-transparent border-none outline-none text-[#014f86] dark:text-white placeholder-slate-400 focus:ring-0"
                        />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 lg:gap-2 p-2 lg:p-0">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full sm:w-48 appearance-none bg-slate-50 dark:bg-slate-800 border-none rounded-xl px-4 py-3.5 pr-8 text-sm font-medium text-slate-700 dark:text-slate-200 cursor-pointer focus:ring-2 focus:ring-[#014f86]/20 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                            >
                ...
                {(selectedDepartment !== "All" || selectedLocation !== "All" || selectedType !== "All" || search) && (
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <button
                            ...
                            className="text-sm text-[#014f86] hover:text-[#014f86] font-medium flex items-center gap-1"
                        >
                ...
                <div className="grid gap-6">
                    {paginatedJobs.length > 0 ? (
                        paginatedJobs.map((job) => (
                            <div
                                key={job.id}
                                className="group relative p-6 md:p-8 rounded-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-[#014f86]/30 dark:hover:border-[#014f86]/30 shadow-sm hover:shadow-xl hover:shadow-[#014f86]/5 transition-all duration-300"
                            >
                                <div className="flex flex-col md:flex-row gap-6 md:items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex flex-wrap gap-2 mb-4">
                                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-sans bg-blue-50 text-blue-700 dark:bg-[#014f86]/10 dark:text-[#014f86] border border-blue-100 dark:border-[#014f86]/20">
                                        ...
                                        <h3 className="text-3xl font-sans text-[#014f86] dark:text-white mb-3 group-hover:text-[#014f86] dark:group-hover:text-[#014f86] transition-colors">
                                            {job.title}
                                        </h3>
                                    ...
                                    <Link href={`/careers/${job.id}`} className="mt-2 md:mt-0 shrink-0">
                                        <button className="w-full md:w-auto px-6 py-3 bg-[#014f86] dark:bg-white text-white dark:text-[#014f86] rounded-xl font-sans  hover:shadow-xl hover:-translate-y-0.5 transition-all active:scale-95">
                                            Apply Now
                                        </button>
                                    </Link>
                                </div>
                        ...
                        <div className="text-center py-20 bg-slate-50 dark:bg-slate-900/50 rounded-5xl border border-dashed border-slate-300 dark:border-slate-800">
                            ...
                            <h3 className="text-lg font-Inter text-[#014f86] dark:text-white mb-2">No positions found</h3>
                            <p className="text-slate-500 dark:text-slate-400 max-w-sm mx-auto mb-6">
                                We couldn't find any roles matching your criteria. Try clearing filters or searching for something else.
                            </p>
                            <button onClick={clearFilters} className="text-[#014f86] dark:text-[#014f86] font-medium hover:underline">Clear all filters</button>
                        </div>
                    )}
                </div>
                        ...
                        <div className="flex gap-2">
                            {Array.from({ length: totalPages }).map((_, i) => (
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-xl text-sm font-Inter transition-all ${currentPage === i + 1
                                        ? "bg-[#014f86] text-white shadow-lg shadow-blue-600/30 scale-105"
                                        : "bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-[#014f86] dark:hover:border-[#014f86] hover:text-[#014f86] dark:hover:text-[#014f86]"
                                        }`}
                                >
                                    {i + 1}
                                </button>
