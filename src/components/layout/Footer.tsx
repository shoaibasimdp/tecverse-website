                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-[#666666]">
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:info@tecverse.io" className="hover:text-red-400 transition-colors">
                                    info@tecverse.io
                                </a>
                            </li>
                ...
                <div className="mt-16 pt-8 border-t border-slate-200">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="https://www.linkedin.com/company/tecverseio/?originalSubdomain=au" aria-label="LinkedIn" className="text-slate-900 hover:text-red-400 transition-colors">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
